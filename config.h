...
/* brightness control */
static const char light_up[] = "/usr/bin/light -A 5 && $HOME/src/dwm/scripts/./brightnessstatus.sh";
static const char light_down[] = "/usr/bin/light -U 5 && $HOME/src/dwm/scripts/./brightnessstatus.sh";
